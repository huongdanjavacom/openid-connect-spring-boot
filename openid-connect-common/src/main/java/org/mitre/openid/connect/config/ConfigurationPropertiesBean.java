...
/**
 * Bean to hold configuration information that must be injected into various parts of our
 * application. Set all of the properties here, and autowire a reference to this bean if you need
 * access to any configuration properties.
 *
 * @author AANGANES
 *
 */
